# Evaluate cfClone on simulated cfDNA samples
A [Snakemake](https://snakemake.readthedocs.io/en/stable/) workflow that generates in-silico mixtures and runs [cfClone](https://github.com/Roth-Lab/cfclone).
