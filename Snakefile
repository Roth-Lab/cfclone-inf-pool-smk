...
#         config.summary_file,
#     output:
#         config.power_calc_plot_file,
#     conda:
#         "envs/plot.yaml"
#     log:
#         config.get_log_file(config.power_calc_plot_file),
#     shell:
#         "(python scripts/plot_bf.py -i {input} -o {output}) >{log} 2>&1"


# rule merge_fit_plots:
#     input:
#         config.get_fit_plots
#     output:
#         config.fits_plot_file
#     conda:
#         "envs/plot.yaml"
#     log:
#         config.get_log_file(config.fits_plot_file),
#     shell:
#         "(python scripts/merge_pdfs.py -i {input} -o {output}) >{log} 2>&1"


# rule merge_trace_plots:
#     input:
#         config.get_replicate_exec_dirs,
#     output:
#         config.trace_plots_file
#     conda:
#         "envs/plot.yaml"
#     log:
#         config.get_log_file(config.trace_plots_file),
#     shell:
#         "(python scripts/pngs_to_pdf.py -i {input} -o {output}) >{log} 2>&1"
